#Funcoes
{
  ...
  calculaFGInvalidez = function (ValorBenefAnual,Idade,Sexo,TabuaInvalido,TabuaConjuge,TabuaFilho,TaxaJuros,IdadeLimite,DiferencaIdadeConjuge,DiferencaIdadePaisFilhos) {
    ...
    for(n in 0:(max(TabuaInvalido$x)-Idade)) {
      Hx = calculaFGPensaoMorte(ValorBenefAnual,(IdadeConjuge+n),SexoConjuge,"Conjuge",TabuaConjuge,TabuaFilho,TaxaJuros,IdadeLimite,DiferencaIdadePaisFilhos)/ValorBenefAnual
      Vn = TabuaInvalido$v[TabuaInvalido$x==n]
    ...
    FG = ValorBenefAnual*(TabuaInvalido$ax[TabuaInvalido$x==Idade]+Cx)
    return(FG)
  }
...
calculaFGInvalidez(ValorBenefAnual,Idade,Sexo,TabuaInvalido,TabuaConjuge,TabuaFilho,TaxaJuros,IdadeLimite,DiferencaIdadeConjuge,DiferencaIdadePaisFilhos)
